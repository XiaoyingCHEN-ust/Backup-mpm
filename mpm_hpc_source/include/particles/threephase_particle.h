#ifndef MPM_THREEPHASE_PARTICLE_H_
#define MPM_THREEPHASE_PARTICLE_H_
...
// ThreePhaseParticle class
template <unsigned Tdim>
class ThreePhaseParticle : public mpm::Particle<Tdim> {
...
public:
  ...
  ThreePhaseParticle(Index id, const VectorDim& coord);

  // Destructor
  ~ThreePhaseParticle() override{};

  // Delete copy constructor
  ThreePhaseParticle(const ThreePhaseParticle<Tdim>&) = delete;

  // Delete assignment operator
  ThreePhaseParticle& operator = (const ThreePhaseParticle<Tdim>&) = delete;
...
#include "threephase_particle.tcc"

#endif  // MPM_THREEPHASE_PARTICLE_H__
